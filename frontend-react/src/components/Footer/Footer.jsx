        ...
        <div className="footer-grid">
          ...
          <nav className="footer-column" aria-label="Quick links">
            ...
            <ul className="links-list">
              ...
              <li><a href="#">Technologies <span className="chevron">&gt;</span></a></li>
          ...
          <nav className="footer-column" aria-label="Services">
            ...
            <ul className="links-list">
              ...
              <li><a href="#">Edge AI Engineering <span className="chevron">&gt;</span></a></li>
            </ul>
          </nav>
          ...
          <address className="footer-column footer-contact" aria-label="Contact Us">
            ...
            <ul className="contact-list">
              ...
              <li>
                <svg fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path strokeLinecap="round" strokeLinejoin="round" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
